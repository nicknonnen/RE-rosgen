...
LongProf_Derived <- read.csv("../../data/derived/public/longprof_derived.txt", header=FALSE, sep = " ", col.names=c("Junk","Distance","Elevation"))[c(2,3)]
```
...
DpthBf_Max <- 1.5793 # Insert the maximum bankfull depth from your point/reach of interest here, replacing the 8 left of the hash #
